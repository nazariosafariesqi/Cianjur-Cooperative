      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 mb-8 max-w-2xl">
            Bergabunglah dengan koperasi terpercaya di Cianjur. Kami berkomitmen untuk meningkatkan kesejahteraan anggota melalui layanan keuangan yang transparan dan berbasis gotong royong.
          </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-6 max-w-2xl">
            ...
            <div className="text-center animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <div className="text-3xl md:text-4xl font-bold text-primary-foreground mb-2">5000+</div>
              <div className="text-sm text-primary-foreground/80">Anggota Aktif</div>
            </div>
            <div className="text-center animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <div className="text-3xl md:text-4xl font-bold text-primary-foreground mb-2">50M+</div>
              <div className="text-sm text-primary-foreground/80">Aset Dikelola</div>
            </div>
          </div>
        </div>
      </div>
